...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          ...
          <hr>
          <p class="lead font-weight-bold">Silahkan Pesan Barang Sesuai Keinginan Anda <br> </p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <!-- Menu -->
      <div class="container">
        <a href="tambah_menu.php" class="btn btn-success mt-3">TAMBAH DAFTAR BARANG</a>
        <div class="row">
