        ...
        <div id="blog-carousel" class="carousel slide overlay-bottom" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="aset/img/rumahadat.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h2 class="text-primary font-weight-medium m-0">WELCOME TO</h2>
                        <h1 class="display-1 text-white m-0">FORMASU STORE</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="aset/img/rumahadat.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h2 class="text-primary font-weight-medium m-0">FORMASU</h2>
                        <h1 class="display-1 text-white m-0">STORE</h1>
                        <h2 class="text-white m-0">* KUBU GADANG*</h2>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="section-title">
                ...
                <h1 class="display-4">Formasu Store was established in 2018</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
                    <h1 class="mb-3">Our Story</h1>
                    <h5 class="mb-3">Formasu Store menyediakan berbagai macam menu oleh oleh dari sumatera utara. Formasu Store mampu bersaing dengan bisnis lainnya.</h5>
                    <p></p>
                    <a href="" class="btn btn-secondary font-weight-bold py-2 px-4 mt-2">Learn More</a>
                </div>
                <div class="col-lg-4 py-5 py-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="aset/img/.png" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4 py-0 py-lg-5">
                    <h1 class="mb-3">Our Address</h1>
                    <p> Formasu  Store berlokasi di Jalan Jambu 4, Kubu Gadang, Payakumbuh</p>
